        ...
        <div className="flex flex-col lg:flex-row lg:items-stretch lg:h-[393px]">
          <div className="lg:w-2/6 min-h-[320px] lg:h-full p-6 bg-gray-200 ">
            ...
            <p className="my-4 text-sm">
              Of course, the entire Offorte team is available throughout the
              week to help and support you. <br /> <br />
              To the right are the direct contact persons who have the lead
              during this project.
            </p>
